...
Require Import Bang_Parametricity_Pre.
Require Export Bang_Parametricity_Interface.
...
Definition wfr (r : rel) (T T' : typ) : Prop :=
  (wf_typ nil T) /\
  (wf_typ nil T').

Lemma wfr_inv : forall r T T',
  wfr r T T' ->
  (wf_typ nil T) /\
  (wf_typ nil T').
Proof. auto. Qed.

Lemma wfr_left_inv : forall t t' R,
  wfr R t t' -> wf_typ nil t.
Proof.
  intros.
  inversion H. auto.
Qed.

Lemma wfr_right_inv : forall t t' R,
  wfr R t t' -> wf_typ nil t'.
Proof.
  ...
  *)
    ...
    (forall x x',
     ...
     (exists w, exists w',
      ...
      F_related_values t1 rsubst dsubst dsubst' w w') ->
     (exists u, exists u',
...
Inductive F_related_subst : env -> lenv -> gamma_subst -> gamma_subst -> gamma_subst -> gamma_subst -> rho_subst -> delta_subst -> delta_subst -> Prop:=
  ...
  | F_related_subst_kind :
    ...
    *)
    forall (E:env) (lE:lenv) (gsubst gsubst' lgsubst lgsubst':gamma_subst) (rsubst:rho_subst) (dsubst dsubst':delta_subst) X R t t',
      F_related_subst E lE gsubst gsubst' lgsubst lgsubst' rsubst dsubst dsubst'->
      X `notin` (fv_env E) `union` (fv_lenv lE) ->
      wfr R t t' ->
      F_related_subst ([(X, bind_kn)]++E) lE gsubst gsubst' lgsubst lgsubst'
  ...
  | F_related_subst_typ :
    ...
    *)
    forall (E:env)(lE:lenv)(gsubst gsubst' lgsubst lgsubst':gamma_subst) (e e':exp) (t:typ) (rsubst:rho_subst) (dsubst dsubst':delta_subst) (x:atom),
      F_related_subst E lE gsubst gsubst' lgsubst lgsubst' rsubst dsubst dsubst'->
      typing nil nil e (apply_delta_subst_typ dsubst t) ->
      typing nil nil e' (apply_delta_subst_typ dsubst' t) ->
      ...
      F_related_subst ([(x, bind_typ t)]++E) lE
                   ([(x, e)]++gsubst) ([(x, e')]++gsubst') lgsubst lgsubst' rsubst dsubst dsubst'
    ...
    *)
    forall (E:env)(lE:lenv)(gsubst gsubst' lgsubst lgsubst':gamma_subst) (e e':exp) (t:typ) (rsubst:rho_subst) (dsubst dsubst':delta_subst) (x:atom),
      ...
      F_related_subst E ([(x, lbind_typ t)]++lE)
                   gsubst gsubst' ([(x, e)]++lgsubst) ([(x, e')]++lgsubst') rsubst dsubst dsubst'
      .
...
Inductive F_Rsubst : env-> rho_subst-> delta_subst -> delta_subst -> Prop:=
  ...
  | F_Rsubst_rel :
    ...
    *)
    forall (E:env) (rsubst:rho_subst) (dsubst:delta_subst) (dsubst':delta_subst) R t t' X,
      F_Rsubst E rsubst dsubst dsubst' ->
      wfr R t t' ->
      X `notin` (fv_env E) ->
      F_Rsubst ([(X, bind_kn)]++E) ([(X, R)]++rsubst) ([(X, t)]++dsubst) ([(X, t')]++dsubst')
  | F_Rsubst_typ :
    (*
      env |- rho_subst \in delta_subst <-> delta_subst'
     -----------------------------------------------------------------
...
Lemma F_related_values_arrow_eq: forall (t1 t2:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
  F_related_values (typ_arrow t1 t2) rsubst dsubst dsubst' v v'
  <->
  (
    (value v) /\ (value v') /\
    (forall x x',
...
Proof. 
  intros.
  unfold_sub F_related_values (typ_arrow t1 t2).
  split; intros H; decompose [and] H. 
    split; auto.
    split; auto.
Qed.

Lemma F_related_values_arrow_leq: forall (t1 t2:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
  F_related_values (typ_arrow t1 t2) rsubst dsubst dsubst' v v'
  ->
  (
    (value v) /\ (value v') /\
...
Proof. 
  intros.
  destruct (@F_related_values_arrow_eq t1 t2 rsubst dsubst dsubst' v v'); auto.
Qed.

Lemma F_related_values_arrow_req: forall (t1 t2:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
  (
    (value v) /\ (value v') /\
    (forall x x',
     typing nil nil x (apply_delta_subst_typ dsubst t1) ->
...
Lemma F_related_values_all_eq: forall (t1:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
  F_related_values (typ_all t1) rsubst dsubst dsubst' v v'
  <->
      (
      (value v) /\ (value v') /\
      (exists L,
...
Proof. 
  intros.
  unfold_sub F_related_values (typ_all t1).
...
Lemma F_related_values_all_leq: forall (t1:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
  F_related_values (typ_all t1) rsubst dsubst dsubst' v v'
  ->
      (
      (value v) /\ (value v') /\
...
Proof. 
  intros.
  destruct (@F_related_values_all_eq t1 rsubst dsubst dsubst' v v'); auto.
Qed.

Lemma F_related_values_all_req: forall (t1:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
      (
      (value v) /\ (value v') /\
      (exists L,
         (forall (X:atom) t2 t2' R (Fr:X `notin` L),
...
Lemma F_related_values_bang_eq: forall (t1:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
  F_related_values (typ_bang t1) rsubst dsubst dsubst' v v'
  <->
    (value v) /\ (value v') /\
    (exists e1, exists e1', 
      v = exp_bang e1 /\
...
Proof. 
  intros.
  unfold_sub F_related_values (typ_bang t1).
  split; intros H; decompose [and] H; clear H.
...
Lemma F_related_values_bang_leq: forall (t1:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
  F_related_values (typ_bang t1) rsubst dsubst dsubst' v v'
  ->
    (value v) /\ (value v') /\
    (exists e1, exists e1',
...
Proof. 
  intros.
  destruct (@F_related_values_bang_eq t1 rsubst dsubst dsubst' v v'); auto.
Qed.

Lemma F_related_values_bang_req: forall (t1:typ) (rsubst:rho_subst)(dsubst dsubst':delta_subst)(v v':exp),
    (value v) /\ (value v') /\
    (exists e1, exists e1', 
      v = exp_bang e1 /\
      v' = exp_bang e1' /\
...
Proof.
  ...
  decompose [and] H; subst; clear H; auto.
  Case "typ_bang".
  apply F_related_values_bang_leq in H.
  decompose [and] H; subst; clear H; auto.
  Case "typ_with".
...
Definition P_Frel_weaken_stronger (n:nat) := 
  ((forall t E E' v v' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 t2',
  typ_size t = n ->
  ...
  *
  ...
  wf_delta_subst (E'++[(X,bind_kn)]++E) (dsubst0++[(X,t2)]++dsubst) ->
  wf_delta_subst (E'++[(X,bind_kn)]++E) (dsubst'0++[(X,t2')]++dsubst') ->
...
Proof.
  ...
  split.
  intros t E E' v v' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 t2'
  ...
  repeat(split; simpl_env; auto).
     ...
     simpl in Hfv.
     apply Hrel_wft1'_wft1 with (E:=E) (E':=E') in Hrel_wft1'; auto; simpl_env.
       SSCase "arrow".
       destruct (@Harrow x x') as [u [u' [Hnorm_vxu [Hnorm_v'x'u' Hrel_wft1]]]]; auto.
          apply typing_dsubst_stronger with (E:=E'++[(X,bind_kn)]++E)(X:=X)(t:=t2); eauto using wfr_left_inv.
             eapply dsubst_weaken; eauto using wfr_left_inv.
          apply typing_dsubst_stronger with (E:=E'++[(X,bind_kn)]++E)(X:=X)(t:=t2'); eauto using wfr_right_inv.
  ...
  repeat(split; simpl_env in *; auto).
     ...
     apply H in G1. destruct G1 as [Hrel_wft1_wft1' Hrel_wft1'_wft1].
     simpl in Hfv.
     apply Hrel_wft1_wft1' with (X:=X)(R:=R)(t2:=t2)(t2':=t2')(E:=E) (E':=E') in Hrel_wft1; auto; simpl_env.
       SSCase "arrow".
       destruct (@Harrow x x') as [u [u' [Hnorm_vxu [Hnorm_v'x'u' Hrel_wft1']]]]; auto.
          apply typing_dsubst_weaken with (E:=E'++E); eauto using wfr_left_inv.
               apply dsubst_stronger with (t:=t2) (X:=X); eauto using wfr_left_inv.
          apply typing_dsubst_weaken with (E:=E'++E); eauto using wfr_right_inv.
               apply dsubst_stronger with (t:=t2') (X:=X); eauto using wfr_right_inv.
          exists (w). exists (w'). split; auto.
...
Lemma Frel_weaken:  forall t E E' v v' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 t2',
  ((F_related_values t (rsubst'++rsubst) (dsubst0++dsubst) (dsubst'0++dsubst') v v' ->
  ddom_env E [=] dom dsubst ->
  ddom_env E [=] dom dsubst' ->
  ddom_env E' [=] dom dsubst0 ->
...
Lemma Frel_weaken_head:  forall t E v v' rsubst dsubst dsubst' X R t2 t2',
  ((F_related_values t rsubst dsubst dsubst' v v' ->
  ddom_env E [=] dom dsubst ->
  ddom_env E [=] dom dsubst' ->
  ddom_env E [=] dom rsubst ->
...
Lemma Frel_stronger:  forall t E E' v v' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 t2',
  F_related_values t (rsubst'++[(X,R)]++rsubst) (dsubst0++[(X,t2)]++dsubst) (dsubst'0++[(X,t2')]++dsubst') v v' ->
  ddom_env E [=] dom dsubst ->
  ddom_env E [=] dom dsubst' ->
  ddom_env E' [=] dom dsubst0 ->
...
Lemma bindsgE__bindsgsubst: forall E lE gsubst gsubst' lgsubst lgsubst' rsubst dsubst dsubst' x T,
    ...
    (exists e, exists e',
                ((binds x (e) gsubst)
                *(binds x (e') gsubst')
                *(typing nil nil e (apply_delta_subst_typ dsubst T))*(typing nil nil e' (apply_delta_subst_typ dsubst' T))
                *(F_related_terms T rsubst dsubst dsubst' e e'))%type)
    .
Proof.
  ...
  Case "F_related_subst_kind".
    ...
    split; auto.
       ...
       split; auto.
       split; auto.
         apply Frel_weaken_head with (E:=E) (X:=X) (R:=R)
  ...
  Case "F_related_subst_typ".
    ...
    SCase "x0<>x".
      analyze_binds Hbinds.
        ...
        destruct BindsTac as [J1 [J2 [e0 [e'0 [[[[Hbinds1 Hbinds2] Ht] Ht'] [v [v' [Htt [Htt' [Hnorm [Hnorm' Hrel]]]]]]]]]]].
        split.
         apply wf_lgamma_subst__nfv with (x:=x) in Hwflg; auto.
           decompose [and] Hwflg; auto.
        split.
...
Proof.
  ...
  Case "F_related_subst_kind".
    ...
    destruct Hbinds as [J1 [J2 [e [e' [[[[Hbinds Hbinds'] Ht] Ht'] [v [v' [Htt [Htt' [Hnorm [Hnorm' Hrel]]]]]]]]]]].
    split; auto.
    split; auto.
       exists (e). exists (e').
       split; simpl; auto.
...
Lemma F_Rel__R__wfr: forall (E:env) (t:typ) (rsubst:rho_subst) dsubst dsubst' (R:rel),
  F_Rel__R t E rsubst dsubst dsubst' R -> 
  wf_typ E t ->
  wfr R (apply_delta_subst_typ dsubst t) (apply_delta_subst_typ dsubst' t).
Proof.
  intros E t rsubst dsubst dsubst' R Hr_eq Hwft.
...
Definition P_parametricity_subst_value (n:nat) := 
  forall t E E' e e' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 k,
  typ_size t = n ->
  ...
  (F_related_values (open_tt_rec k (typ_fvar X) t) 
               ...
               (dsubst'0++[(X,(apply_delta_subst_typ (dsubst'0++dsubst') t2))]++dsubst') 
                e e' ->
  wf_rho_subst (E'++[(X, bind_kn)]++E) (rsubst'++[(X, R)]++rsubst) ->
  wf_delta_subst (E'++[(X, bind_kn)]++E) (dsubst0++[(X,(apply_delta_subst_typ (dsubst0++dsubst) t2))]++dsubst) -> 
  wf_delta_subst (E'++[(X, bind_kn)]++E) (dsubst'0++[(X,(apply_delta_subst_typ (dsubst'0++dsubst') t2))]++dsubst') -> 
...
Proof.
  ...
  intros t E E' e e' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 k
         Htsize Hwft Hwft' Hwft2 Hr_eq Hfv H1dsubst  H1dsubst'  H1dsubst0  H1dsubst'0 H1rsubst  H1rsubst'.
  assert (wfr R (apply_delta_subst_typ (dsubst0++dsubst) t2) (apply_delta_subst_typ (dsubst'0++dsubst') t2)) as WFR. 
  ...
  repeat(split; auto; simpl_env in * ).
         ...
         destruct (@Harrow x x') as [u [u' [Hnorm_vxu [Hnorm_v'x'u' Hrel_wft1]]]]; auto.
           ...
           SSCase "arrow_left". 
           assert (typ_size t1 < typ_size (typ_arrow t1 t3)) as G1. simpl. omega.
           apply H with (E:=E) (E':=E') (e:=v) (e':=v') (t:=t1)
       ...
       SCase "all".  
         ...
         SSCase "F_Rel_R".
           ...
           SSSCase "R -> Rrel".
             ...
             destruct (@Hrel_rel v0 v'0) as [Hrel_r Hr_rel].
             unfold F_Rel in *.
             apply Frel_weaken_head with (E:=E'++E) (X:=X4) (R:=R0)
  ...
  destruct Hrel as [Hv [Hv'[e1 [e1' [Heq [Heq' 
       ...
       exists (u1). exists (u1'). repeat(split; auto).
               assert (typ_size t < typ_size (typ_bang t)) as G1. simpl. omega.
               apply H with (E:=E) (E':=E') (e:=u1) (e':=u1') (t:=t)
                        (rsubst:=rsubst) (dsubst:=dsubst) (dsubst':=dsubst')
                        (X:=X) (R:=R) (t2:=t2) (k:=k)
                        (rsubst':=rsubst') (dsubst0:=dsubst0) (dsubst'0:=dsubst'0) in G1; auto.
                 destruct G1 as [Hrel_wft1_wft1' Hrel_wft1'_wft1].
         ...
         unfold F_Rel__R in *. destruct Hr_eq as [ HHwfd [ HHwfd' [ HHwfr Hrel_rel]]].
           ...
           intro Hrel.
             ...
             apply Frel_stronger with (E:=E'++E) (E':=@nil (atom*binding)) (X:=X2) (R:=R0) 
                            ...
                            (dsubst:=dsubst0++dsubst) (dsubst0:=delta_nil)
                            (dsubst':=dsubst'0++dsubst') (dsubst'0:=delta_nil)
                            (t2:=t3) (t2':=t2'); simpl_env in *; simpl; auto; simpl_env .
...
Lemma parametricity_subst_value : forall t E E' e e' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 k,
  wf_typ (E'++[(X,bind_kn)]++E) (open_tt_rec k (typ_fvar X) t)->
  wf_typ (E'++E) (open_tt_rec k t2 t) ->
  wf_typ (E'++E) t2 ->
  F_Rel__R t2 (E'++E) (rsubst'++rsubst) (dsubst0++dsubst) (dsubst'0++dsubst') R ->
...
Proof.
  ...
  decompose [prod] (@H t E E' e e' rsubst rsubst' dsubst dsubst' dsubst0 dsubst'0 X R t2 k
...
Proof.
  ...
  exists (apply_delta_subst dsubst' (apply_gamma_subst gsubst' (apply_gamma_subst lgsubst' (exp_tabs e1)))).
   ...
   exists(u). exists (u').
      ...
      SCase "Frel".
      unfold open_tt.
      assert (F_related_values (open_tt_rec 0 T T1) (rho_nil++rsubst) (delta_nil++dsubst) (delta_nil++dsubst') u u' =
                  F_related_values (open_tt_rec 0 T T1) rsubst dsubst dsubst' u u').
         simpl. reflexivity.
      rewrite <- H0.
  ...
  Case "typing_let".
   ...
   assert (wf_lgamma_subst E D2 dsubst gsubst lgsubst2) as Wflg2.
     ...
     assert (wf_lgamma_subst E D2 dsubst' gsubst' lgsubst2') as Wflg2'.
     apply F_related_subst__inversion in J4. decompose [prod] J4; auto.
   assert (typing [] [] x1 (apply_delta_subst_typ dsubst T1)) as Typing1.
   ...
   apply H0 with (dsubst:=dsubst) (dsubst':=dsubst') 
         ...
         split.
           ...
           apply typing_let with (L:=L `union` dom (gsubst) `union` dom (lgsubst2) `union` dom E)(D1:=[])(D2:=[])(T1:=apply_delta_subst_typ dsubst T1); auto.
             intros x Hfv.
